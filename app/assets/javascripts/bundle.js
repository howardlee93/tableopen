...
/***/ "./frontend/components/display.jsx":
/*!*****************************************!*\
  !*** ./frontend/components/display.jsx ***!
  \*****************************************/
...
function (_React$Component) {
  ...
  function Display(props) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Display).call(this, props));
  }
  ...
  return Display;
}(react__WEBPACK_IMPORTED_MODULE_0___default.a.Component); // const Display = ({ businesses }) => {
//   return (
...
/* harmony import */ var _components_search__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/search */ "./frontend/components/search.jsx");
/* harmony import */ var _components_display__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/display */ "./frontend/components/display.jsx");
...
function (_React$Component) {
  ...
  function Root(props) {
    ...
    _this.fetchRestaurantsAPI = _this.fetchRestaurantsAPI.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(Root, [{
    key: "onFormSubmit",
    value: function onFormSubmit(query) {
      console.log("Querying Yelp for ".concat(query));
      this.setState({
        query: "".concat(query)
      });
      console.log("Querying Yelp for ".concat(this.state.businesses));
    ...
    key: "fetchRestaurantsAPI",
    value: function fetchRestaurantsAPI(query) {
      var _this2 = this;

      var params = {
        location: "".concat(query),
        // 'Cupertino'
        //terms: `${query}`,
        limit: 5,
        categories: 'food'
      };
      axios__WEBPACK_IMPORTED_MODULE_4___default.a.get('https://cors-anywhere.herokuapp.com/'.concat(url), {
        headers: headers,
        params: params
      }).then(function (res) {
        console.log(res);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Root, null), rootEl);
});
